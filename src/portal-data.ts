...
export const stats = [
  ...
  { value: 'By Brand', label: 'Clear browsing by brand and folder', icon: 'fa-folder-tree', tone: 'success' },
  { value: 'Fast Access', label: 'Quick file access and support flow', icon: 'fa-hard-drive', tone: 'info' },
  { value: 'Trusted', label: 'Clean delivery for repair work', icon: 'fa-shield-halved', tone: 'warning' },
]
...
export const pages: Record<SitePageKey, SitePage> = {
  home: {
    ...
    heroCopy: '',
    quickLabel: 'Main Access',
    primaryEyebrow: 'Core Services',
    primaryTitle: 'Huawei & Honor Access',
    primaryItems: homeFocusCards,
    packageEyebrow: 'Latest Packages',
    packageTitle: 'Latest Huawei & Honor Packages',
    packageItems: homePackages,
    featureEyebrow: 'Why Choose This Portal',
    featureTitle: 'Built Around Huawei, Honor, Kirin, and HarmonyOS',
    featureItems: homeFeatures,
    ctaEyebrow: 'Start Here',
    ctaTitle: 'Open the right files faster for Huawei, Honor, Kirin, HarmonyOS, and Qualcomm jobs.',
    ctaCopy: 'Use the sections above to go straight to the files, folders, or support page you need.',
  },
  huawei: {
    key: 'huawei',
    ...
    featureTitle: 'Why Start from This Huawei Section',
  ...
  honor: {
    ...
    featureTitle: 'Why Start from This Honor Section',
  ...
  kirin: {
    ...
    featureTitle: 'Why Start from This Kirin Section',
  ...
  harmony: {
    ...
    featureTitle: 'Why Start from This HarmonyOS Section',
